...
import { validateEmail } from "../services/reducer";
    ...
    <div className="signUp">
      ...
      <div className="signUp_container">
        ...
        <form>
          <h5>First Name</h5>
          <input
            className="signUp_firstNameInput"
            type="text"
            value={firstName}
          ...
          <h5>Last Name</h5>
          <input
            className="signUp_lastNameInput"
            type="text"
            value={lastName}
          ...
          <button onClick={register} className="signUp_registerButton">
            Create Account
          </button>
        </form>
      </div>
